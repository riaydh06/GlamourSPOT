...
import { fetchUpdateProduct, getAllProducts } from '../../store/actions/productActions'
...
class UpdateProduct extends Component {
  ...
  componentDidUpdate(nextProps) {
    ...
    if (updateProduct && !nextProps.updateProduct) {
  ...
  updateProduct = () => {
    const { item } = this.props.navigation.state.params;
    const { brand, name, type, description, image, link, colours } = this.state;
    ...
    this.props.handleFetchUpdateProduct(item._id, postData);
              ...
              <View>
                {
                  this.state.isProcessing ? <Spinner size="small" color="white" /> :
                    <Text style={styles.buttonsTextStyle}>Update Product</Text>
                }
              </View>
            </TouchableOpacity>
          </View>
...
const mapDispatchToProps = dispatch => ({
    handleFetchUpdateProduct: (id, postData) => {
      dispatch(fetchUpdateProduct(id, postData));
    },
